...
{
    public class CheckVouchController : ApiController
    {
        public HttpResponseMessage Post([FromBody] dynamic json)
        {
            ...
            try
            {
                ...
                responseData = CheckVouch.CheckVouchAdd(requestData);
            ...
            {
                LogException.WriteJSlog("CheckVouch", requestData, responseData);
            }
        }
    }
}
