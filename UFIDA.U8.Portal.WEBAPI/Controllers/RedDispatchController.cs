...
{
    public class RedDispatchController : ApiController
    {
        public HttpResponseMessage Post([FromBody] dynamic json)
        {
            ...
            try
            {
                ...
                try
                {
                    d = JsonConvert.DeserializeObject<RedDispatch>(requestData);
                }
                catch
                {
                ...
                responseData = RDSDAL.RedDispatch(d);
                return new HttpResponseMessage
                {
                    Content = new StringContent(responseData, Encoding.UTF8, "application/json")
                };
            ...
            {
                LogException.WriteJSlog("RedDispatch", requestData, responseData);
            }
        }
    }
}
