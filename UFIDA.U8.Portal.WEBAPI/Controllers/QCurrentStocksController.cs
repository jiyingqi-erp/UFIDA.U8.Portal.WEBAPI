    ...
    public class QCurrentStocksController : ApiController
    {
        public HttpResponseMessage Post([FromBody] dynamic json)
        {
            ...
            try
            {
                ...
                try
                {
                    stock = JsonConvert.DeserializeObject<QCurrentStock>(requestData);
                }
                catch
                {
                ...
                responseData = CurrentStockDAL.QueryCurrentStocks(stock);
                return new HttpResponseMessage
                {
                    Content = new StringContent(responseData, Encoding.UTF8, "application/json")
                };
            ...
            {
                LogException.WriteJSlog("QCurrentStocks", requestData, responseData);
            }
        }
    }
}
